...
curl -L -o w10x64.img https://bit.ly/3J1tE5d
...
$endc$enda""";
sudo qemu-system-x86_64 -vnc :0 -hda w10x64.img  -smp cores=2  -m 8192M -machine usb=on -device usb-tablet > /dev/null 2>&1
